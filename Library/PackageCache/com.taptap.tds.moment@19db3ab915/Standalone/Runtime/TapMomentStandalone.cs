...
namespace TapTap.Moment.Standalone {
    public class TapMomentStandalone : ITapMomentBridge {
        public void Open(Orientation orientation) {
            ...
            if (config == null || config.RegionType == RegionType.CN) {
        ...
        public void SetDefaultOrientation(Orientation orientation){
            TapLogger.Warn($"{nameof(SetDefaultOrientation)} NOT implemented.");
        }
        
        public void Open(){
            Open(Orientation.ORIENTATION_DEFAULT);
        }
        ...
        public void PublishVideo(string[] videoPaths, string[] imagePaths, string title, string desc) {
            TapLogger.Warn($"{nameof(PublishVideo)} NOT implemented.");
        }

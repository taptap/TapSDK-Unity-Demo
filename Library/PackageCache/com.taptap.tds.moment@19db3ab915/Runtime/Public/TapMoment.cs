...
namespace TapTap.Moment {
    ...
    public class TapMoment {
        ...
        public static void SetDefaultOrientation(Orientation orientation) {
            moment.SetDefaultOrientation(orientation);
        }
        ...
        public static void Publish(string[] imagePaths, string content) {
            moment.Publish(imagePaths, content);
        }
        ...
        public static void PublishVideo(string[] videoPaths, string[] imagePaths, string title,
            string desc) {
            moment.PublishVideo(videoPaths, imagePaths, title, desc);
        }
        ...
        public static void PublishVideo(string[] videoPaths, string title, string desc) {
            moment.PublishVideo(videoPaths, title, desc);
        }
        ...
        public static void DirectlyOpen(string page, Dictionary<string, object> extras) {
            moment.DirectlyOpen(page, extras);
        }

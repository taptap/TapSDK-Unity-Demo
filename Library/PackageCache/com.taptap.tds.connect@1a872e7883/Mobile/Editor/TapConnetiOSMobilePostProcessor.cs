...
public class BuildPostProcessor
{
    ...
    public static void TapConnetiOSMobilePostProcessor(BuildTarget buildTarget, string path)
    {
        if (buildTarget == BuildTarget.iOS)
        {
            ...
            if (TapCommonCompile.HandlerIOSSetting(path,
                ...
                "Connect",
                new[] {"TapConnectResource.bundle"},
                target, projPath, proj))
            {
                Debug.Log("TapConnect add Bundle Success!");
                return;
            }

            Debug.LogWarning("TapConnect add Bundle Failed!");
        }
    }
}
#endif

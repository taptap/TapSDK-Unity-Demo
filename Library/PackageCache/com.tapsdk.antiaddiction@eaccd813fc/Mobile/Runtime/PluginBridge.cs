...
namespace Plugins.AntiAddictionUIKit
{
    public static class AntiAddictionUIKit
    {
        ...
        private const string UNITY_SDK_VERSION = "3.18.7";
        ...
        [DllImport("__Internal")]
        #endif
        private static extern void startupWithUserId(string userIdentifier, bool isTapUser);
            ...
            )
        {
            ...
            startupWithUserId(userIdentifier, isTapUser);
        }

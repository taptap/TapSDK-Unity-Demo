...
namespace TapTap.AntiAddiction.Internal
{
    internal static class Network {
        ...
        {
            string path = $"real-name/v1/{TapTapAntiAddictionManager.AntiAddictionConfig.regionStr}/clients/{gameId}/users/{TapTapAntiAddictionManager.UserId}";
        ...
        internal static async Task<VerificationResult> VerifyKycAsync(string json, string key)
        {
            ...
            {
                string path = $"real-name/v1/{TapTapAntiAddictionManager.AntiAddictionConfig.regionStr}/clients/{gameId}/users/{TapTapAntiAddictionManager.UserId}/manual";
        ...
        {
            string path = $"anti-addiction/v1/{TapTapAntiAddictionManager.AntiAddictionConfig.regionStr}/clients/{gameId}/users/{TapTapAntiAddictionManager.UserId}/playable";
        ...
        {
            string path = $"anti-addiction/v1/{TapTapAntiAddictionManager.AntiAddictionConfig.regionStr}/clients/{gameId}/users/{TapTapAntiAddictionManager.UserId}/payable";
            Dictionary<string, object> headers = GetAuthHeaders();
            Dictionary<string, object> data = new Dictionary<string, object> 
            {
                { "amount", amount }
        ...
        {
            string path = $"anti-addiction/v1/{TapTapAntiAddictionManager.AntiAddictionConfig.regionStr}/clients/{gameId}/users/{TapTapAntiAddictionManager.UserId}/payments";
            Dictionary<string, object> headers = GetAuthHeaders();
            Dictionary<string, object> data = new Dictionary<string, object> 
            {
                { "amount", amount }

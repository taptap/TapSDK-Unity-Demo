...
+ (void)startupWithUserID:(NSString *)userID __attribute__((deprecated("Please use [AntiAddiction startupWithUserID:isTapUser:]")));

/// 启动防沉迷&实名系统
/// @param userID 游戏维度的用户唯一标识
+ (void)startupWithUserID:(NSString *)userID isTapUser:(bool)isTapUser;
...
+ (void)startUpUseTapLogin:(BOOL)useTapLogin userIdentifier:(NSString *)userIdentifier __attribute__((deprecated("Please use [AntiAddiction startupWithUserID:isTapUser:]")));

...
namespace TapTap.TapDB.Standalone.Internal {
    public class User {
        ...
        public void Login(string userId, string loginType = null, Dictionary<string, object> props = null) {
            ...
            TapDBStandalone.Tracker.TrackUserProperties(Constants.PROPERTY_INITIALIZE_TYPE, initProps);
            ...
            TapDBStandalone.Tracker.TrackUserProperties(Constants.PROPERTY_UPDATE_TYPE, updateProps);
